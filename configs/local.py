...
proxy = dict(
    ...
    memory_adapters=dict(
        ...
        qwen_memory=dict(
            type="QwenMemoryClient",
            name="qwen_memory_client",
    ...
    conversation_adapters=dict(
        ...
        qwen_agent=dict(
            type="QwenConversationClient",
            name="qwen_agent_client",
            agent_prompts_file="configs/agent_prompts.yaml",
            qwen_model_name="qwen-turbo-latest",
            proxy_url=__proxy_url__,
        ),
        qwen_omni_realtime_agent=dict(
            type="QwenOmniRealtimeConversationClient",
            name="qwen_omni_realtime_agent_client",
            agent_prompts_file="configs/agent_prompts.yaml",
            wss_url="wss://dashscope.aliyuncs.com/api-ws/v1/realtime",
    ...
    reaction_adapters=dict(
        ...
        qwen_reaction=dict(
            type="QwenReactionClient",
            name="qwen_reaction_client",
            motion_keywords="http://127.0.0.1:18080/api/v1/motion_keywords",
            proxy_url=__proxy_url__,
            qwen_model_name="qwen-turbo-latest",
        ),
    ...
    asr_adapters=dict(
        ...
        qwen_realtime_asr=dict(
            type="QwenRealtimeASRClient",
            name="qwen_realtime_asr_client",
            wss_url="wss://dashscope.aliyuncs.com/api-ws/v1/inference",
            qwen_model_name="qwen-asr-realtime",
            proxy_url=__proxy_url__,
            queue_size=5000,
        ),
