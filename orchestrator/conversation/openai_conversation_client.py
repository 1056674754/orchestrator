...
class OpenAIConversationClient(ConversationAdapter):
    """OpenAI conversation client for streaming chat and reject operations.

    This client provides streaming conversation capabilities using OpenAI
    ...
    ExecutorRegistry.register_class("OpenAIConversationClient")
    ...
    async def _init_llm_client(self, request_id: str) -> None:
        ...
        """
        openai_api_key = self.input_buffer[request_id]["chat_task"].get("api_keys", {}).get("openai_api_key", "")
